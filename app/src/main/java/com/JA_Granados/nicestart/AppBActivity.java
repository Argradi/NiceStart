...
public class AppBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_bactivity);
        ...
        myfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(AppBActivity.this, "FAB Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bottomAppBar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AppBActivity.this, "Menu clicked", Toast.LENGTH_SHORT).show();
        ...
        bottomAppBar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.item1) {
                    Toast.makeText(AppBActivity.this, "Added to favourites", Toast.LENGTH_SHORT).show();
                    return true;
                } else if (id==R.id.item2) {
                    Toast.makeText(AppBActivity.this, "Beginning search", Toast.LENGTH_SHORT).show();
                    return true;
                }
                return false;
            }
        ...
        /*private void showBottomSheetDialog() {
            ...
            option1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(AppBActivity.this, "Settings clicked", Toast.LENGTH_SHORT).show();
